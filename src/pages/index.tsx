  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Your Table, while we empower restaurant employees to manage reservations and menus seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Your Table, while we empower restaurant employees to manage reservations and menus seamlessly.`}
            </Text>
            <Box
